      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
          ...
          <tbody>
              <tr v-for="item in data.data" :key="item.date">
                  ...
                  <td class="border-b-2 border-gray-200 px-4 py-3">{{item.average}}円</td>
                  <td class="border-b-2 border-gray-200 px-4 py-3">{{item.totalPerGroup}}円</td>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
            <tr>
                ...
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Recency</th>
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Frequency</th>
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Monetary</th>
            </tr>
        </thead>
        <tbody>
